...
| 文件 | 用途 | 自动生成 |
| --- | --- | --- |
| kelee.lsr | 下载 Kelee Loon 规则的输入清单 | 否 |
| png.lsr | 下载 PNG 图标的输入清单 | 否 |
| ad.lsr | 下载广告规则的输入清单 | 否 |
| mihomo.lsr | 下载 Mihomo 原生资源的输入清单 | 否 |
| geo.lsr | 下载 GeoIP、GeoSite 和 MMDB 的输入清单 | 否 |

根目录清单 Raw 地址（点击代码框右上角的复制按钮即可复制）：
...
下表只放文件名和用途，避免长 URL 把表格单元格撑高。每个分类下面的代码框包含该分类的完整 Raw 地址，地址顺序与表格一致；点击代码框右上角即可一键复制整组地址。

### Kelee Loon 规则

| 文件 | 用途 |
| --- | --- |
| `kelee/AI.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Alibaba.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Apple.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Baidu.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/BiliBili.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/ChinaASN.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/ChinaMax.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/ChinaMobile.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/ChinaTelecom.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/DouYin.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/GaoDe.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/GitHub.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Global.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Google.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Instagram.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/JingDong.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/KugouKuwo.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Microsoft.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/NetEase.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/NetEaseMusic.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Pinduoduo.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/SpeedtestInternational.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Telegram.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Tencent.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/TestFlight.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/TikTok.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/Twitter.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/WeChat.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/XiaoMi.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
| `kelee/YouTube.lsr` | Loon / Egern 规则，可直接作为规则资源引用 |
...
| 文件 | 用途 |
| --- | --- |
| `png/Adblock.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/AI.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Apple.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/baidunetdisk(1).png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/bilibili_3.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/ChatGPT.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/China.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/CN.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/dianxin.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Emby-0decdc6c.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Emby-dc841cc2.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Final.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/GitHub.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Global.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Google.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Google_Search.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/HK.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Hong_Kong.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Instagram-4f81a6f8.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Instagram-533227d7.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Japan.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/jingdong.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/JP.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Korea.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/KR.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/kugou.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Macao.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Malaysia.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/mega.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Microsoft-5de51988.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Microsoft-d11688b0.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/MO.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Netease.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Netflix.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/PayPal.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/pinduoduo.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Proxy.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/QQ.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/SG.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Singapore.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Speedtest.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Steam.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Taobao.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Telegram.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/tengxunditu.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/testflight(2).png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/TikTok_1.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/TikTok-27034e11.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/TikTok-5f5d2f2c.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/TW.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Twitter.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/United_States.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/Unlock.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/US.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/wechat(1).png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/yidong(1).png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
| `png/YouTube.png` | Loon / Egern 分组图标，可直接作为图标 URL 引用 |
...
| 文件 | 用途 |
| --- | --- |
| `ad/adrules.list` | 广告过滤规则，按文件实际格式在客户端中引用 |
| `ad/Ads_AWAvenue.yaml` | 广告过滤规则，按文件实际格式在客户端中引用 |
| `ad/Advertising.list` | 广告过滤规则，按文件实际格式在客户端中引用 |
...
| 文件 | 用途 |
| --- | --- |
| `geo/country.mmdb` | Mihomo、Loon 或其他支持对应格式的 Geo 数据库 |
| `geo/geoip.dat` | Mihomo、Loon 或其他支持对应格式的 Geo 数据库 |
| `geo/GeoLite2-ASN.mmdb` | Mihomo、Loon 或其他支持对应格式的 Geo 数据库 |
| `geo/geosite.dat` | Mihomo、Loon 或其他支持对应格式的 Geo 数据库 |
...
| 文件 | 用途 |
| --- | --- |
| `mihomo/ads.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Binance.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Crypto.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Discord.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Facebook.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/fakeip-filter.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/LinkedIn.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/netflix-2b0a4ed1.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/netflix-512b2f11.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/OKX.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/PayPal.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/private-1fa87d08.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/private-275bfa0d.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/proxy.mrs` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Reddit.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/Steam.yaml` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
| `mihomo/WebRTC.list` | 原本就是 Mihomo 格式的资源，可直接作为 Provider 或配置资源 |
...
| 文件 | 用途 |
| --- | --- |
| `mihomo/domain/AI.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Alibaba.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Apple.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Baidu.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/BiliBili.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/ChinaMax.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/ChinaMobile.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/ChinaTelecom.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/DouYin.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/GaoDe.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/GitHub.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Global.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Google.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Instagram.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/JingDong.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/KugouKuwo.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Microsoft.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/NetEase.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/NetEaseMusic.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Pinduoduo.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/SpeedtestInternational.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Telegram.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Tencent.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/TestFlight.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/TikTok.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/Twitter.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/WeChat.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/XiaoMi.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
| `mihomo/domain/YouTube.mrs` | Mihomo `behavior: domain` 的 MRS Provider |
...
| 文件 | 用途 |
| --- | --- |
| `mihomo/ipcidr/AI.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Alibaba.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Apple.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/BiliBili.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/ChinaMax.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/ChinaMobile.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Global.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Google.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/KugouKuwo.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/NetEase.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/NetEaseMusic.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/SpeedtestInternational.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Telegram.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Tencent.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/Twitter.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/XiaoMi.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
| `mihomo/ipcidr/YouTube.mrs` | Mihomo `behavior: ipcidr` 的 MRS Provider |
...
| 文件 | 用途 |
| --- | --- |
| `mihomo/classical/AI.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Apple.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/ChinaASN.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/ChinaMax.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/GitHub.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Global.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Google.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Instagram.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Microsoft.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Telegram.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/TestFlight.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/TikTok.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/Twitter.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/WeChat.list` | Mihomo `behavior: classical` 的文本 Provider |
| `mihomo/classical/YouTube.list` | Mihomo `behavior: classical` 的文本 Provider |
...
| 文件 | 用途 |
| --- | --- |
| `mihomo/unsupported/Apple.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/BiliBili.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/ChinaMax.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/Global.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/Google.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/Microsoft.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/NetEaseMusic.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/Tencent.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/TikTok.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/WeChat.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
| `mihomo/unsupported/YouTube.list` | 仅用于查看无法自动转换的规则，不应直接启用 |
...
| Provider | 文件 | behavior |
| --- | --- | --- |
| Global 域名 | `mihomo/domain/Global.mrs` | domain |
| Global IP | `mihomo/ipcidr/Global.mrs` | ipcidr |
| Global 经典规则 | `mihomo/classical/Global.list` | classical |
| Microsoft 域名 | `mihomo/domain/Microsoft.mrs` | domain |
| Apple 域名 | `mihomo/domain/Apple.mrs` | domain |
| YouTube 域名 | `mihomo/domain/YouTube.mrs` | domain |
| 广告规则 | `mihomo/ads.mrs` | Mihomo 原生 MRS |
| Fake-IP 过滤 | `mihomo/fakeip-filter.mrs` | Mihomo 原生 MRS |
